...
```javascript
groupIn = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/utils-group-in@v0.2.1-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/utils-group-in/actions/workflows/test.yml/badge.svg?branch=v0.2.1
[test-url]: https://github.com/stdlib-js/utils-group-in/actions/workflows/test.yml?query=branch:v0.2.1
