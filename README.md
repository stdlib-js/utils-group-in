...
```javascript
import groupIn from 'https://cdn.jsdelivr.net/gh/stdlib-js/utils-group-in@v0.1.0-deno/mod.js';
```
...
[@stdlib/utils/bifurcate-in]: https://github.com/stdlib-js/utils-bifurcate-in/tree/deno
